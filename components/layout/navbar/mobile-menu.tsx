  ...
  return (
    <>
      <button
        ...
        className='flex h-11 w-11 items-center justify-center rounded-md border border-neutral-700 text-white md:hidden'
      >
            ...
            <Dialog.Panel className="fixed bottom-0 left-0 right-0 top-0 flex h-full w-full flex-col pb-6">
              <div className="p-4">
                ...
                <ul className="flex w-full flex-col">
                  <li
                    className="py-2 text-xl transition-colors hover:text-neutral-500 text-white"
                  >
