...
export default function SlidePrevButton({slidesCount}: any) {
  const swiper = useSwiper();

  return (
    <button onClick={() => swiper.slidePrev()} className={`${s.prev} ${slidesCount === 1 && s.disabled}`} aria-label="previous slide">
      <svg
        width="23"
        height="19"
        viewBox="0 0 27 24"
